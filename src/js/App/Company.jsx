...
const strings = {
  section: '会社概要',
  title1: <span>すべての方に<br/>成功への第一歩を。</span>,
  title2: <span>すべての女性に<br/>起業のチャンスを。</span>,
  ...
  paragraph4: 'また、日本にふさわしいスタートアップ企業と投資家の関係を, 考えたとき、新たなエンゲージメントの確立によって企業とエンジェル投資家が持続的なコミットメントと支援を互いに約束し共に成長することが、より多くのアントレプレナーとその支援者であるエンジェル投資家を増やしていくことにつながります。',
